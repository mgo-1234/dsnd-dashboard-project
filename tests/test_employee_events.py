...
def test_db_exists(db_path):
    ...
    assert db_path.is_file(), "The employee_events.db file does not exist at the expected path."
...
def test_employee_table_exists(table_names):
    ...
    assert 'employee' in table_names, "Table 'employee' not found in database."
...
def test_team_table_exists(table_names):
    ...
    # is in the table_names list
    assert 'team' in table_names, "Table 'team' not found in database."
...
def test_employee_events_table_exists(table_names):
    ...
    # is in the table_names list
    assert 'employee_events' in table_names, "Table 'employee_events' not found in database."
